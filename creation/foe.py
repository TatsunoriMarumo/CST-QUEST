...
def create_foe_julian():
    """
    Create a foe, also known as an instructor, Julian
...
def create_foe_sam():
    """
    Create a foe, also known as an instructor, Sam
...
def create_foe_hoda():
    """
    Create a foe, also known as an instructor, Hoda
...
def create_foe_nabil():
    """
    Create a foe, also known as an instructor, Nabil
...
def create_foe_maryam():
    """
    Create a foe, also known as an instructor, Maryam
...
def create_foe_chris():
    """
    Create a foe, also known as an instructor, Chris
